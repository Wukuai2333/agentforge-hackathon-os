...
function Admin() {
  ...
  <div className="status-guide"><span><i className="on-track" /> <b>On track</b> active and progressing</span><span><i className="needs-help" /> <b>Needs help</b> stalled or repeated errors</span><span><i className="blocked" /> <b>Blocked</b> cannot continue without intervention</span></div></section>
